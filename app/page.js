...
const Hero = () => {
  ...
  useEffect(() => {
    // Set opening date to April 17, 2025 9:30 AM Sri Lanka time (UTC+5:30)
...
{/* 
          <motion.button
            className="gold-bg text-black font-semibold py-3 px-8 rounded-full button-glow"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
          >
        ...
        <div className="text-center text-sm text-gray-400">
          <p>&copy; 2025 Aurora Elegance. All rights reserved.</p>
